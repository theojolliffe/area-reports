...
<script>	
  ...
  import { tweened } from 'svelte/motion';
	...
	export let buffer = 5;
	export let colors = ['#A8BD3A', '#003C57', '#27A0CC', '#118C7B', '#F66068', '#746CB1', '#22D0B6', 'lightgrey', '#206095'];
	export let r = 4;
...
{#if legend && zDomain}
  <Legend domain={zDomain} {colors} markerLength={Array.isArray(r) ? r[0] * 4 : r * 2} round={true}/>
{/if}
{#if footer}
